...
listhatnorm = []
for i in listhat:
    listhatnorm.append( (i.norm())**(1/N) )  # hope to fix the norm to be the L2 norm; however Im not sure if (i.norm())**(2/N) is correct
